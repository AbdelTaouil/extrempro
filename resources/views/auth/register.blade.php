                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <select id="avatar_id" type="text" class="form-control @error('avatar_id') is-invalid @enderror" name="avatar_id" value="{{ old('avatar_id') }}" required autocomplete="avatar_id" autofocus>
                                    @foreach ($avatardata as $item)
